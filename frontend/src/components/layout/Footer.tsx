...
export default function Footer({ navigate }: FooterProps) {
  ...
  const whatsappHref = business.whatsapp.replace(/\D/g, '')
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 28 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                ...
                <p style={{ fontSize: 13, color: 'var(--ivory-muted)', lineHeight: 1.55, margin: 0 }}>{business.address}</p>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <a href={`mailto:${business.email}`} style={{ fontSize: 13, color: '#FFFFFF', textDecoration: 'none', transition: 'opacity 0.2s' }}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                {phoneHref ? (
                  <a href={`tel:${phoneHref}`} style={{ fontSize: 13, color: '#FFFFFF', textDecoration: 'none' }}>{business.phone}</a>
                ) : (
                  <span style={{ fontSize: 13, color: 'var(--ivory-muted)' }}>{business.phone}</span>
                )}
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                {whatsappHref ? (
                  <a href={`https://wa.me/${whatsappHref}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: '#FFFFFF', textDecoration: 'none' }}>WhatsApp us</a>
                ) : (
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              ...
              {/* Instagram */}
              {business.instagram && (
              <a href={business.instagram} target="_blank" rel="noopener noreferrer" title="Instagram" style={{
              ...
              {/* Facebook */}
              {business.facebook && (
              <a href={business.facebook} target="_blank" rel="noopener noreferrer" title="Facebook" style={{
                width: 32, height: 32, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center',
              ...
              {/* X */}
              {business.x && (
              <a href={business.x} target="_blank" rel="noopener noreferrer" title="X (Twitter)" style={{
                width: 32, height: 32, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center',
              ...
              {/* LinkedIn */}
              {business.linkedin && (
              <a href={business.linkedin} target="_blank" rel="noopener noreferrer" title="LinkedIn" style={{
                width: 32, height: 32, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center',
              ...
              {/* TikTok */}
              {business.tiktok && (
              <a href={business.tiktok} target="_blank" rel="noopener noreferrer" title="TikTok" style={{
                width: 32, height: 32, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center',
